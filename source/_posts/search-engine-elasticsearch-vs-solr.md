---
title: 搜索引擎介绍Elasticsearch和Solr
date: 2018-04-19 13:13:15
tags: [elasticsearch,solr]
id: 20180419
categories: 转载
---
...
![](http://i.zhcy.tk/images/search_fresh_index_while_idle.png)

当实时建立索引时, Solr会产生io阻塞，查询性能较差, Elasticsearch具有明显的优势。

![](http://i.zhcy.tk/images/search_fresh_index_while_indexing.png)

随着数据量的增加，Solr的搜索效率会变得更低，而Elasticsearch却没有明显的变化。

![](http://i.zhcy.tk/images/search_fresh_index_while_indexing2.png)
...
![](http://i.zhcy.tk/images/average_execution_time.jpg)
...
原文： [http://i.zhcy.tk/blog/elasticsearchyu-solr/](http://i.zhcy.tk/blog/elasticsearchyu-solr/)